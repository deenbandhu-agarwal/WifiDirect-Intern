...
public class WiFiServiceDiscoveryActivity extends Activity implements
    ...
    private static WifiP2pDnsSdServiceInfo service;
    ...
    //
    static final int SERVER_PORT_2 = 4546;
    ...
    private void startRegistrationAndDiscovery() {
        ...
        record.put("NoOfNodes",""+no_of_nodes);
    ...
    private void discoverService() {
         ...
         * by the system when a serv0ice is actually discovered.
         */
        ...
        manager.setDnsSdResponseListeners(channel,
                new DnsSdServiceResponseListener() {
                    ...
                    public void onDnsSdTxtRecordAvailable(
                        ...
                        no_of_nodes = Integer.parseInt(record.get("NoOfNodes").toString());
                        Log.d(TAG,
        ...
        if (p2pInfo.isGroupOwner) {
            ...
            try {
                handler = new GroupOwnerSocketHandler(
                        ((MessageTarget) this).getHandler(), context);

                Log.i("i am group owner ",""+p2pInfo.groupOwnerAddress);
                handler.start();
            } catch (IOException e) {
                Log.d(TAG,
            ...
            handler = new ClientSocketHandler(
                    ...
                    p2pInfo.groupOwnerAddress, context);


            /*  Removes the service from the app if the device is connected as client not as group owner */
                ...
                manager.removeLocalService(channel, service, new ActionListener() {
                    ...
                    public void onSuccess() {
                        ...
                        Log.i("success removal","dgdsgsgsgsg");
                    }

                    @Override
                    public void onFailure(int error) {
                        Log.i("failed removal","failed removal service");
